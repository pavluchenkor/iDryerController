...
void setup()
{
    ...
    #endif
    PID.SetTunings(double(iDryer.data.Kp), double(iDryer.data.Ki), double(iDryer.data.Kd), P_ON_M);
...
void loop()
{
    ...
    case DRY:
        ...
        if(millis() - printOldTime > 500)
        {
            ...
            Serial.print(dimmer);
            Serial.print("\t min: ");
            Serial.print(PID.GetOutputLimitsMin());
            Serial.print("\t max: ");
            Serial.println(PID.GetOutputLimitsMax());
