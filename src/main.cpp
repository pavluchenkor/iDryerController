...
servo Servo2(SERVO_2_PIN, eeprom_read_word(&menuVal[DEF_SERVO2_OPEN]), eeprom_read_word(&menuVal[DEF_SERVO2_OPEN]), eeprom_read_word(&menuVal[DEF_SERVO2_CORNER]));
...
void setup()
{
    ...
    if (errorCode)
    {
        ...
        eeprom_write_dword((uint32_t *)&WDT_ERROR, 0);
    }
