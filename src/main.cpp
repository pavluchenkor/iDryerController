...
void setup()
{
  ...
  eeprom_write_dword(&offset_eep[1], 1);
    ...
    do
    {
        oled.drawUTF8((128 - oled.getUTF8Width("ПРОШЕЙ")) / 2, lineHight * 2, "ПРОШЕЙ");
        oled.drawUTF8((128 - oled.getUTF8Width("ЧАСТЬ 2")) / 2, lineHight * 3, "ЧАСТЬ 2");
    } while (oled.nextPage());
    delay(300000);
#endif
}
...
void autoPid()
{
    ...
    do
    {
        ...
        oled.drawUTF8((128 - oled.getUTF8Width(printMenuItem(&serviceTxt[DEF_T_SAVED]))) / 2, lineHight * 3, printMenuItem(&serviceTxt[DEF_T_SAVED]));
    } while (oled.nextPage());
    ...
    while (time_delay)
    {
        ...
        do
        {
            ...
            oled.drawUTF8((128 - oled.getUTF8Width(printMenuItem(&serviceTxt[DEF_T_COOLING]))) / 2, lineHight * 2, printMenuItem(&serviceTxt[DEF_T_COOLING]));
